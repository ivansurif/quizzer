...
document.getElementById('manualForm').addEventListener('submit', function(e) {
    ...
    const formData = {
        ...
        question:
            { title: questionTitle, type: questionType, questionText },
        answers: [
            ...
            {answerItem5: document.getElementById('answerItem5').value, answerItem4IsCorrect: document.getElementById('answerItem5IsCorrect').checked }
        ]
    };

    if (!projectName || !moduleName || !questionTitle || !questionType || !questionText || !answerItem1 ) {
...
;
    ...
    .then(data => {
        ...
        document.getElementById('questionTitle').value = defaultModuleName;
